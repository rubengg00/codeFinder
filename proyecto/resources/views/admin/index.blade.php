            ...
            <div class="card border-0 shadow mb-4" id="card">
                <div class="shadow-lg p-3 mb-5 bg-white rounded">
                    ...
                    <div class="row  ">
                        ...
                        <br><br>
                    <h5 class="text-center">En esta página podrás ver, editar, y eliminar a todos los <span class="text-primary font-italic">usuarios</span>, <span class="text-danger font-italic">posts</span> y
